...
namespace _01_DB.Migrations
{
    ...
    [Migration("20230708050713_add_estimate")]
    partial class add_estimate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_01_DB.Entities.BeerEstimate", b =>
                {
                    ...
                    b.HasKey("BeerId", "EstimateId");

                    b.HasIndex("EstimateId");

                    b.ToTable("BeerEstimate", (string)null);
                });
            ...
            modelBuilder.Entity("_01_DB.Entities.Estimate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_01_DB.Entities.BeerEstimate", b =>
                {
                    b.HasOne("_01_DB.Entities.Estimate", "estimate")
                        .WithMany("Beers")
